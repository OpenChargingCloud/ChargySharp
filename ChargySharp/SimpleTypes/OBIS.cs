...

    {
        ...
        public static OBIS ParseHex(String Text)
        {
            ...
            if (Text.IsNullOrEmpty())
                throw new ArgumentNullException(nameof(Text), "The given hexadecimal text representation of an OBIS identification must not be null or empty!");
            ...
            if (TryParseHex(Text, out OBIS obis))
                return obis;

            throw new ArgumentNullException(nameof(Text), "The given hexadecimal text representation of an OBIS identification is illegal!");
